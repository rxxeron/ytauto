    ...
    try {
      if (isSignUp) {
        ...
        if (data.session) {
          ...
          setMessage('Account created successfully! Check your email to confirm, or sign in.');
        }
      } else {
      ...
      <div className="glass-panel animate-fade-in" style={{ padding: '40px', width: '400px', maxWidth: '90%' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)' }}>
            {isSignUp ? 'Create your account to start generating' : 'Sign in to manage AI stories'}
          </p>
        </div>
